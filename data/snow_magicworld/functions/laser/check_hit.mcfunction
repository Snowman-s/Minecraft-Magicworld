...
execute unless entity @s[tag=better_hit] at @e[distance=..1,tag=!snow_laser,type=player] unless score @e[sort=nearest,limit=1,tag=!snow_laser] PlayerID = @s EntityID run function snow_magicworld:laser/onhit
execute unless entity @s[tag=better_hit] if entity @s[tag=!not_hit_witch] at @e[distance=..1,tag=!snow_laser,type=!player] if data entity @e[sort=nearest,limit=1,tag=!snow_laser] Brain run function snow_magicworld:laser/onhit
execute unless entity @s[tag=better_hit] if entity @s[tag=not_hit_witch] at @e[distance=..1,tag=!snow_laser,type=!witch,type=!player] if data entity @e[sort=nearest,limit=1,tag=!snow_laser] Brain run function snow_magicworld:laser/onhit
