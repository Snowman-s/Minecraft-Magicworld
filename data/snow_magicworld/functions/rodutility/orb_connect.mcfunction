...
execute if data entity @s {SelectedItem:{tag:{SnowMagicRod:{MainSlotId:""}}}} run item entity @s weapon.mainhand modify snow_magicworld:copy_orb/main
...
execute if score #SubSlotNum Temporary matches 1.. unless data entity @s[tag=!OrbConnectedMain] SelectedItem.tag.SnowMagicRod.SubSlotIDs[0] run item entity @s weapon.mainhand modify snow_magicworld:copy_orb/sub
...
execute if score #SubSlotNum Temporary matches 2.. unless data entity @s[tag=!OrbConnectedMain, tag=!OrbConnected1] SelectedItem.tag.SnowMagicRod.SubSlotIDs[1] run item entity @s weapon.mainhand modify snow_magicworld:copy_orb/sub

execute unless entity @s[tag=!OrbConnectedMain, tag=!OrbConnected1, tag=!OrbConnected2] run item entity @s weapon.offhand modify snow_magicworld:minus_count
