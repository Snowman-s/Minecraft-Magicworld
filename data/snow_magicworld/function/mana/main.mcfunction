...
execute if entity @s[predicate=snow_magicworld:has_rod] unless items entity @s weapon.mainhand *[minecraft:custom_data~{"snow_magicworld:magic_rod":{sub_slot_ids:["accel_mana"]}}] if score @s MaxMana > @s Mana run scoreboard players add @s ManaTime 1
execute if entity @s[predicate=snow_magicworld:has_rod] if items entity @s weapon.mainhand *[minecraft:custom_data~{"snow_magicworld:magic_rod":{sub_slot_ids:["accel_mana"]}}] if score @s MaxMana > @s Mana run scoreboard players add @s ManaTime 2
