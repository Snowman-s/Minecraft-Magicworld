...
execute if items entity @s weapon.mainhand *[minecraft:custom_data~{"snow_magicworld:magic_rod":{main_slot_id:"worldwalker"}}] if entity @s[predicate=!snow_magicworld:in_magicdimension] at @s in snow_magicworld:magicdimension run effect give @s jump_boost 30 255 true
